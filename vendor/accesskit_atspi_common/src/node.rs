...
// Locally modified to expose expansion states and add regression tests.
// See ../PATCH.md for provenance and patch details.
...
// Local regression coverage; see ../PATCH.md.
#[cfg(test)]

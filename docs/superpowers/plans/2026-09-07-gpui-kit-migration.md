...
- [ ] Review specification compliance and code quality independently; fix findings and rerun affected checks. Record exact verified revisions and platform limits, integrate into the application repository, and install only the verified build. Leave GitHub automation disabled.

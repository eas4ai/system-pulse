...
| Accepted diagnostic frame | Opt-in bounded publication of the actual consumed snapshot and rendered labels. Sequence and render revision support native comparisons; stale rendering preserves original acceptance time. [Diagnostics](../../examples/system_pulse/src/diagnostics.rs). |

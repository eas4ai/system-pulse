...
Evidence: [fixture.rs](../../src/fixture.rs:76).
...
Evidence: [history insertion](../../crates/model/src/readings.rs:60), [reading tests](../../crates/model/tests/readings.rs).
...
Mechanism: `cargo test --locked -p system-pulse-model --test readings`.
Evidence: [validation](../../crates/model/src/readings.rs:32), [timestamp check](../../crates/model/src/readings.rs:66).
...
Evidence: [timer](../../src/workspace.rs:322), [advance](../../src/fixture.rs:107), [native evidence](../../docs/native-fixture-acceptance.md:12).

There is no bound on the number of distinct history keys in the present type. That matters when replacing its finite catalog with dynamic hardware discovery. Evidence: [series map](../../crates/model/src/readings.rs:44), [key insertion](../../crates/model/src/readings.rs:74).

...
Evidence: [state types](../../crates/model/src/presentation.rs:34), [tests](../../crates/model/tests/presentation.rs).
...
Evidence: [Session::restore](../../crates/model/src/persistence.rs:18), [native record](../../docs/native-fixture-acceptance.md:19).
...
Evidence: [validator](../../src/workspace.rs:94).
...
Evidence: [storage resolver](../../src/storage.rs:12).

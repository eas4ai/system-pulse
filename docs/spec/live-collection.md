...
Baseline evidence: [percentage clamping](../../examples/system_pulse/src/meters.rs:29), [untyped meter choices](../../examples/system_pulse/model/src/presentation.rs:7); intended kinds: [product matrix](/home/shawn/workspace2/task-manager/docs/feature-spec-dockable-system-monitor.md:97).
...
Baseline evidence: [one existing timer](../../examples/system_pulse/src/workspace.rs:322), [per-series history without key eviction](../../examples/system_pulse/model/src/readings.rs:44); intended intervals: [product spec](/home/shawn/workspace2/task-manager/docs/feature-spec-dockable-system-monitor.md:205).
...
Baseline evidence: [approved workspace contract](/home/shawn/workspace2/task-manager/docs/superpowers/specs/2026-09-04-workspace-visibility-design.md), [verified baseline](../../examples/system_pulse/NATIVE_ACCEPTANCE.md).

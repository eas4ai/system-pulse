...
Baseline evidence: [fixture formula](../../src/fixture.rs:76), [runtime feed](../../src/workspace.rs:404), [missing collector dependency](../../Cargo.toml:8).
...
Baseline evidence: [fixed catalog](../../src/fixture.rs:11).
...
Baseline evidence: [generated rows and fixed navigation](../../src/panel.rs:247).
...
Baseline evidence: [synthetic timestamps](../../src/fixture.rs:91); the existing sample model rejects [non-finite values](../../crates/model/src/readings.rs:32).
...
Baseline evidence: [percentage clamping](../../src/meters.rs:29), [untyped meter choices](../../crates/model/src/presentation.rs:7); intended kinds: [product matrix](../feature-spec-dockable-system-monitor.md:97).
...
Presentation amendment (developer request, 2026-09-07): omit unavailable sensor rows and their inline Show controls from normal panel bodies. Retain their status, unit and reason in collection/history and diagnostic data; preserve saved sensor choices and restore eligible rows on recovery. Failed, stale and warming-up readings remain explicit. This filtering does not change monitor visibility or process-table error reporting.
...
Baseline evidence: [existing three-state reading model](../../crates/model/src/readings.rs:6), [compact formatter](../../src/meters.rs:5). The implementation may model warm-up through explicit unavailable metadata rather than adding a redundant state.
...
Baseline evidence: [fixture-only validator](../../src/workspace.rs:94), [fixture storage path](../../src/storage.rs:12), [existing invalid-input retention](../../crates/model/src/persistence.rs:18).
...
Baseline evidence: app feed ownership is [WorkspaceView](../../src/workspace.rs:322).
...
Baseline evidence: [one existing timer](../../src/workspace.rs:322), [per-series history without key eviction](../../crates/model/src/readings.rs:44); intended intervals: [product spec](../feature-spec-dockable-system-monitor.md:205).
...
Baseline evidence: [approved workspace contract](../superpowers/specs/2026-09-04-workspace-visibility-design.md), [verified baseline](../../docs/native-fixture-acceptance.md).
...
Baseline evidence: [runtime toolbar](../../src/workspace.rs:672), [entry title](../../src/main.rs:21), [fixture module](../../src/lib.rs:2).
...
Baseline evidence: the broader [product field list](../feature-spec-dockable-system-monitor.md:41) exceeds the [fixture catalog](../../src/fixture.rs:11).
...
Baseline evidence: [existing acceptance](../../docs/native-fixture-acceptance.md) proves fixture interactions and supplies no host-accuracy comparison.

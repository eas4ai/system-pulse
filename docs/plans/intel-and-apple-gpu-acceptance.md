...
Preparation and activation were completed on 2026-09-06 in commit `66ea860f`. Intel Linux code and focused tests passed independent specification and quality reviews at collector commit `507a12c0`; native Intel evidence remains pending. Apple collector source `2a40f069` passed 96 Linux and 46 native Mac tests, strict checks and repeated native load captures. Independent specification and quality reviews closed after a runtime-confirmed autorelease defect was corrected. Task 3 memory and persistence integration closed at `4db68c71` after independent specification and quality reviews: 183 Linux tests and strict checks passed, plus a separate Mac build and 63 app tests. Task 4 independent GPU acceptance is in progress. Full Apple accuracy and UI acceptance remain pending. Read-only [Apple source probes](../execution/intel-and-apple-gpus/apple-source-probe.md) establish source availability; they do not establish production collector accuracy or native acceptance.

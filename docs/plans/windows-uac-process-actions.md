...
- [ ] In progress: activate the approved commitment, declare mechanisms and scope, and record the framework upgrade design after inspecting upstream and local patches.
- [ ] Upgrade GPUI Kit and reconcile companion/native patches; verify the locked graph and applicable local checks.

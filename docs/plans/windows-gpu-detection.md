...
- [ ] In progress: implement vendor-independent discovery and available usage/memory readings; verify vendor/identity/removal/error boundaries and Linux/macOS preservation.

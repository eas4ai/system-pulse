...
All three source findings are resolved. The full committed aggregate at `e5838365931efb6b07ecf412a433c34302ee5c26` passed 932 automated tests, all fourteen native preservation cases, packaged product flows and installed smoke. Direct final source/visual review and artifact verification are recorded in [the usable Linux checkpoint](linux-application-checkpoint.md). The separate inventory-timeout artifact remains failed; the unchanged isolated probe and fresh full repeat passed. No independent or complete GPU commitment review is claimed.

...
At this app checkpoint the pinned Linux AccessKit AT-SPI adapter omits expanded/expandable state. The app exposes correct AccessKit expanded values and has a direct regression test; the platform adapter correction remains an integration prerequisite.
